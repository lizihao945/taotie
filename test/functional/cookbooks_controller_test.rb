...
class CookbooksControllerTest < ActionController::TestCase
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post :create, cookbook: { description: @cookbook.description, difficulty_level: @cookbook.difficulty_level, time_level: @cookbook.time_level, tips: @cookbook.tips, user: @cookbook.user }
    end
  ...
  test "should update cookbook" do
    put :update, id: @cookbook, cookbook: { description: @cookbook.description, difficulty_level: @cookbook.difficulty_level, time_level: @cookbook.time_level, tips: @cookbook.tips, user: @cookbook.user }
    assert_redirected_to cookbook_path(assigns(:cookbook))
  end
